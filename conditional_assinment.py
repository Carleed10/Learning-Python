...
# numbers_input = input("Enter three numbers separated by commas (e.g., 1,2,3): ").split()
# x, y, z = numbers_input
...
# # x, y, z = map(float, numbers_input.split(','))
...
# palindrome = input("Please enter a word: ").replace(" ", "").lower()
...
# alphabet = input("Enter a single alphabet character: ").lower()
# vowel = ['a', 'e', 'i', 'o', 'u']
...
# message = input(str("Enter a sentence: ")).lower()
